...
#Exibe o tipo do atributo antes da mudança
class(nf$Valor)

nf$Valor <- trimws(gsub("[R$.]","",nf$Valor))
nf$Valor <- as.numeric(gsub(",",".", nf$Valor))

#Exibe o tipo do atributo após a coerção
class(nf$Valor)
...
#Agrupar por CNPJ e Mês (extração)
...
#Verifica visualmente se as NF estão em sequência
...
#Verificar se o registro dos impostos recolhidos é maior que o 
...
#Data frame unindo os DF das NF com informações sobre impostos recolhifos e o arquivo com os limites de auditoria
